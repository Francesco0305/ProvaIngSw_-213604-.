	...
	public int stringToIntConverter(String number) {
		...
		try {
			...
			if(result>= -32768 && result<= 32767) {
				...
				throw new UnsupportedOperationException("Il numero deve essere compreso tra -32768 e 32767");
			}
			
		} catch (NumberFormatException e) {
			System.out.println("Formato sbagliato non puoi inserire lettere, spazi o caratteri speciali");
